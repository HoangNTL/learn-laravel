...
@section('title', 'Shop - UntreeStore')

@section('content')

<!-- Copy content từ shop.html vào đây -->
        ...
        <div class="col-md-9">
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
              <div class="product-item">
                <a href="#" class="product-img">
                  <img src="{{ asset('clientTheme/assets/images/products/shoe-1-min.jpg') }}" alt="Image" class="img-fluid">
                </a>
            ...
            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
              <div class="product-item">
                <a href="#" class="product-img">
                  ...
                  <img src="{{ asset('clientTheme/assets/images/products/sweater-2-min.jpg') }}" alt="Image" class="img-fluid">
                </a>
            ...
            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
              <div class="product-item">
                <a href="#" class="product-img">
                  ...
                  <img src="{{ asset('clientTheme/assets/images/products/watch-1-min.jpg') }}" alt="Image" class="img-fluid">
                </a>
