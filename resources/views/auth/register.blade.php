            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('auth.register') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Họ và tên" value="{{ old('name') }}">
                ...
                <div class="social-auth-links text-center">
                    ...
                    <a href="#" class="btn btn-block btn-danger">
                        <i class="fab fa-google-plus mr-2"></i> Đăng ký bằng Google+
                    </a>
                </div>

                <a href="{{ route('auth.login') }}" class="text-center">Đã có tài khoản? Đăng nhập</a>
            </div>
        </div>
    </div>
